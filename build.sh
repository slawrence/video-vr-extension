...
uglifyjs libs/three.min.js libs/PointerLockControls.js libs/vr/vr.js libs/vr/OculusRiftControls.js libs/vr/OculusRiftEffect.js libs/make3d.js -o dist/chrome/bundle.js
