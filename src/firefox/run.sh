...
uglifyjs temp.js libs/three.min.js libs/PointerLockControls.js libs/vr/vr.js libs/vr/OculusRiftControls.js libs/vr/OculusRiftEffect.js libs/make3d.js src/firefox/data/content.js -o src/firefox/data/bundle.js
rm temp.js
